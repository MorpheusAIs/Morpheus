...
export interface GasPassNetworkInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "TransactionPaid(address,uint256,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TransactionPaid"): EventFragment;
}
...
export interface TransactionPaidEventObject {
  payer: string;
  gasUsed: BigNumber;
  timestamp: BigNumber;
}
export type TransactionPaidEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  TransactionPaidEventObject
>;

export type TransactionPaidEventFilter = TypedEventFilter<TransactionPaidEvent>;

export interface GasPassNetwork extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GasPassNetworkInterface;
  ...
  filters: {
    ...
    "TransactionPaid(address,uint256,uint256)"(
      payer?: PromiseOrValue<string> | null,
      gasUsed?: null,
      timestamp?: null
    ): TransactionPaidEventFilter;
    TransactionPaid(
      payer?: PromiseOrValue<string> | null,
      gasUsed?: null,
      timestamp?: null
