...
Ссылка на Желтую бумагу Технические детали: [https://github.com/MorpheusAIs/Morpheus/blob/main/YellowPaper.md](https://github.com/antonbosss/Morpheus/blob/main/Yellowpaper-International/YellowPaperRussian.md)
...
Документ детально поясняющий концепцию Машины технокапитала, доступен по [ссылке](https://github.com/antonbosss/Morpheus/blob/main/Techno%20Capital%20Machine%20(TCM)%20International/Techno%20Capital%20Machine%20TCM%20Russian.md)

## Доказательство, регистрация и вознаграждение за вклад в разработку кода: 
Программист (кодер) - это тот, кто загрузил и запустил полный узел Morpheus, подключил свой кошелек и внес свой вклад (код) в разработку агента, смарт-контракт или другое программное обеспечение в сети Morpheus.
...
Провайдером вычислений может называться пользователь, который загрузил и запустил полный узел Morpheus, подключил свой кошелек и готов принимать API / LLM / запросы на вычисления от других пользователей Morpheus. Предоставленные вычисления могут быть рассчитаны путем включения подписанной транзакции, сгенерированной Умным агентом, с возвратом вывода из транзакции MOR. 
...
Данный раздел находится в доработке, детали доступны по ссылке на модель вычислений [Yellowstone](https://github.com/antonbosss/Morpheus/blob/main/Yellowstone%20Computer%20Model-International/Yellowstone%20Compute%20Model%20Russian.md)
...
Более развернутое описание работы защитного фонда доступно по [ссылке](https://github.com/antonbosss/Morpheus/blob/main/!KEYDOCS%20README%20FIRST!/6.Protection%20Fund%20Details.md)
