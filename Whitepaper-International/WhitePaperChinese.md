...
此表并非严谨精确的时间流程，它仅对各阶段进行了大体的描述。社区的成长与繁荣可能需花费数年时间，而区块奖励则预计在大约16年后终止。该长期分配方案意在全球范围内尽可能广泛地推广代币奖励。另外，旨在使区块奖励在长期中稳步下降，以便为所有参与者提供充足的时机进行规划和调整，平缓地从早期的补助式奖励转变为收费模式。
